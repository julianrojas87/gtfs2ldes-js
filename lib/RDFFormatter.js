...
export const RDFFormatter = (templates, context, timestamp) => {
    return new Transform({
        ...
        async transform(conn, encoding, done) {
            ...
            // Make sure date properties are proper Date objects for IRI building
            ...
            const lc = {
                ...
                "departureTime": obj["departureTime"].toISOString(),
                "arrivalTime": obj["arrivalTime"].toISOString(),
                "gtfs:route": routeIRI,
                "gtfs:trip": tripIRI,
                ...
                "departureDelay": obj["departureDelay"],
                "arrivalDelay": obj["arrivalDelay"],
                "departureStop": {
                    "@id": depStopIRI,
                    "@type": "Stop",
